                ...
                <div class = "sub-menu">
                  ...
                  <div class = "sub-menu-item">
                    ...
                    <ul>
                      ...
                      <li><a href = "#">Headphone & Headsets</a></li>
                  ...
                  <div class = "sub-menu-item">
                    <h4>Features</h4>
                    <ul>
                      <li><a href = "#">Google Assistance Store</a></li>
                      <li><a href = "#">ShoppingMania SmartBuy</a></li>
                      ...
                      <li><a href = "#">Complete Mobile Protection</a></li>
                    </ul>
                  </div>
                  <!-- end of item -->
                ...
                <div class = "sub-menu">
                  ...
                  <div class = "sub-menu-item">
                    ...
                    <ul>
                      ...
                      <li><a href = "#">Shaving & Aftersave</a></li>
